...
- Formato é flag do `build.mjs`: 16:9 = `node build.mjs <id>` · 9:16 = `node build.mjs <id> --vertical`.
  Pra **ambos**, gere os dois e renderize cada um pra um arquivo (`<id>-16x9.mp4` / `<id>-9x16.mp4`).
...
Defina-o uma vez e prefixe todos os ids. Saída: `renders/<curso>-deep-t4-m1.mp4`.
